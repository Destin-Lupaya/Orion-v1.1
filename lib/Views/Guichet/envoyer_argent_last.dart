...
class ConfigEnvoieArgentPage extends StatefulWidget {
  final bool updatingData;
  final EnvoieModel? envoieModel;
  const ConfigEnvoieArgentPage(
      {Key? key, required this.updatingData, this.envoieModel})
      : super(key: key);

  @override
  _ConfigEnvoieArgentPageState createState() => _ConfigEnvoieArgentPageState();
}

class _ConfigEnvoieArgentPageState extends State<ConfigEnvoieArgentPage> {
      ...
      child: Column(
        children: [
          ...
          CardWidget(
            ...
            content: Column(
              children: [
                blockSeparator(title: 'Coordonnees du Beneficiaire'),
                Row(children: [
                  Expanded(
                    child: TextFormFieldWidget(
                      maxLines: 1,
                      hintText: 'Nom ou Numero du beneficiaire',
                          ...
                          return CustomButton(
                            ...
                            callback: () async {
                              ...
                              caisseStateProvider.addcaisse(
                                  context: context,
                                  caisseModel: EnvoieModel.fromJson(data),
